...
public class EmailConstant {
    ...
    public static final String USERNAME = "Kenan Orucov";
    public static final String PASSWORD = "kenan741852963";
    public static final String FROM_EMAIL = "kenannorucov19@gmail.com";
